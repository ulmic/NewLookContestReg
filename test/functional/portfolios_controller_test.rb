...
class PortfoliosControllerTest < ActionController::TestCase
  ...
  test "should create portfolio" do
    assert_difference('Portfolio.count') do
      post :create, portfolio: { events: @portfolio.events, honors: @portfolio.honors, id_user: @portfolio.id_user, media: @portfolio.media }
    end
  ...
  test "should update portfolio" do
    put :update, id: @portfolio, portfolio: { events: @portfolio.events, honors: @portfolio.honors, id_user: @portfolio.id_user, media: @portfolio.media }
    assert_redirected_to portfolio_path(assigns(:portfolio))
  end
